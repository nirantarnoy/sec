...
$model_job_main_com_std = \common\models\JobProfitComStd::find()->where(['job_id' => $model->id])->all();
?>
        ...
        <div class="col-lg-6">
            <form action="<?= Url::to(['jobmain/createjobstdcom'], true) ?>" method="post">
                ...
                <table class="table table-bordered">
                        ...
                        <?php foreach ($model_job_main_com_std as $value): ?>
                            <tr>
                                <td style="padding: 0;"><input type="text" style="border: none;text-align: right;"
                                                               class="form-control line-profit-std-amt" value="<?=number_format($value->std_amount,2)?>"
                                                               name="line_profit_std_amt[]"
                                                               onchange="cal_profit_std($(this))">
                                </td>
                                <td style="padding: 0;"><input type="text" style="border: none;text-align:right;"
                                                               class="form-control line-profit-std-com-per" value="<?=number_format($value->commission_per,2)?>"
                                                               name="line_profit_std_com_per[]"
                                                               onchange="cal_profit_std($(this))"></td>
                                <td style="padding: 0;"><input type="text" style="border: none;text-align: right;"
                                                               class="form-control line-profit-std-total-amt" value="<?=number_format($value->commission_amount,2)?>"
                    ...
                    <tfoot>
                    <tr>
                        <td style="text-align: right;padding: 0.2em"><b>Total Achievement Reward:</b></td>
                        <td style="padding: 0;"><input type="text" style="border: none;" class="form-control" name="x"
                                                       value="" readonly></td>
                        <td style="padding: 0;"><input type="text" style="border: none;"
                                                       class="form-control line-profit-std-total-amtx" value=""
                                                       name="line_profit_std_total_amt[]" readonly></td>
                        <td style="padding: 0;"></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;padding: 0.2em"><b>Extra Commission by Company :</b></td>
                        <td style="padding: 0;"><input type="text" style="border: none;" class="form-control" name="x"
                                                       value="" readonly></td>
                        <td style="padding: 0;"><input type="text" style="border: none;"
                                                       class="form-control line-profit-std-total-amtx" value=""
                    ...
                    <tr>
                        <td style="text-align: right;padding: 0.2em"><b>Extra Commission by Team leader :</b></td>
                        <td style="padding: 0;"><input type="text" style="border: none;" class="form-control" name="x"
                                                       value="" readonly></td>
                        <td style="padding: 0;"><input type="text" style="border: none;"
                                                       class="form-control line-profit-std-total-amtx" value=""
                    ...
                    <tr>
                        <td style="text-align: right;padding: 0.2em"><b>Total Commission :</b></td>
                        <td style="padding: 0;"><input type="text" style="border: none;" class="form-control" name="x"
                                                       value="" readonly></td>
                        <td style="padding: 0;"><input type="text" style="border: none;"
                                                       class="form-control line-profit-std-total-amtx" value=""
            ...
            <table class="table table-bordered">
                ...
                if ($team_line) {
                    foreach ($team_line as $value):?>
                        <tr>
                            <td style="padding: 10px 0px 0px 5px;"><?= \backend\models\Employee::findFullName($value->emp_id) ?></td>
