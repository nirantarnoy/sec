        ...
        <div class="col-lg-6">
            <div class="btn-group">
                <?php if ($model->status == 3): ?>
                    <div class="btn btn-success" onclick="approveJob();">อนุมัติ / Approve</div>
                <?php endif; ?>
            </div>
        </div>
...
<input type="hidden" class="current-submit-job-id" value="<?= $model->id; ?>">
...
$url_to_review_payment_job = \yii\helpers\Url::to(['job/approvepayment'], true);
$js = <<<JS
