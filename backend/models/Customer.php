...
class Customer extends \common\models\Customer
{
    ...
    public function rules()
    {
        return [
            [['name'], 'required'],
            [['name'], 'unique','targetAttribute' => ['name'],'message' => 'ชื่อลูกค้าซ้ำในระบบแล้ว'],
            [['status', 'created_at', 'created_by', 'updated_at', 'updated_by','customer_group_id','payment_term_id','payment_method_id'], 'integer'],
            [['phone','email','first_name','last_name'], 'string', 'max' => 255],
            [['address','taxid'], 'string', 'max' => 255],
            [['vat_per_id'],'safe'],
        ];
    }
